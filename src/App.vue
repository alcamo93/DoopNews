      ...
      <div id="upload">
        <div v-if="this.$root.$data.loading === false">
          ...
          <h4>Register news.</h4>
           ...
           <b-form-input 
            type="text" 
            v-model="form.title" placeholder="News title" required>
           </b-form-input>

           <b-form-input 
            type="date" 
            v-model="form.title" placeholder="News date" required>
           </b-form-input>

           <b-form-input 
            type="time" 
            v-model="form.title" placeholder="News time" required>
           </b-form-input>
